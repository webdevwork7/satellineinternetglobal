    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-white/90">
                We're here to help you stay connected. Reach out to our team for assistance.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Have questions about our satellite internet services? Our team of connectivity experts is ready to
                  assist you with choosing the right plan, technical support, or any other inquiries you might have.
                </p>
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        <a href="tel:+18889701698" className="hover:text-teal transition-colors">
                          +1 (888) 970-1698
                        </a>
                      </p>
                    </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        <a href="mailto:support@linkify.com" className="hover:text-teal transition-colors">
                          support@linkify.com
                        </a>
                      </p>
                    </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h3 className="font-bold text-navy">Hours of Operation</h3>
                      <p className="text-gray-600">
        ...
        <section className="py-16 bg-light">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-navy mb-8 text-center">Our Location</h2>
            <div className="bg-white p-2 rounded-lg shadow-md">
              <div className="aspect-video w-full bg-gray-200 rounded">
                <img
                  src="/tech-city-map-pin.png"
                  alt="Linkify office location map"
        ...
        <section className="py-16 bg-gradient-to-br from-navy to-teal/90 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Our connectivity experts are standing by to help you find the perfect satellite internet solution.
            </p>
            <a
