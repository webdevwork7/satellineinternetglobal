    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main>
        ...
        <section className="py-16 bg-gradient-to-br from-navy to-teal/90 text-white">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="mt-8 text-sm text-white/80">Last Updated: May 10, 2023</div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <div className="prose prose-lg max-w-none">
                ...
                <p>
                  At Linkify ("we," "our," or "us"), we respect your privacy and are committed to protecting your
                  personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your
                  information when you visit our website, use our satellite internet services, or interact with us in
                  any way.
                </p>
                <p>
                ...
                <ul>
                  <li>
                    ...
                    billing information, and any other identifier by which you may be contacted online or offline.
                  </li>
                  <li>
                    <strong>Usage Data:</strong> Information about your internet connection, the equipment you use to
                    access our services, usage details, and browsing patterns.
                  </li>
                  <li>
                    <strong>Service Data:</strong> Information related to your satellite internet service, including
                    connection speeds, data usage, and service interruptions.
                  </li>
                  <li>
                    <strong>Customer Service Interactions:</strong> Records of your communications with our customer
                    service team.
                  </li>
                </ul>

                <h2 className="text-2xl font-bold text-navy mb-4 mt-8">How We Collect Information</h2>
                <p>We collect information through:</p>
                <ul>
                  <li>Direct interactions when you provide information to us</li>
                  <li>Automated technologies or interactions as you navigate through our website</li>
                ...
                <h2 className="text-2xl font-bold text-navy mb-4 mt-8">Disclosure of Your Information</h2>
                ...
                <ul>
                  ...
                  <li>
                    If we believe disclosure is necessary to protect the rights, property, or safety of Linkify, our
                    customers, or others
                  </li>
                </ul>
                ...
                <h2 className="text-2xl font-bold text-navy mb-4 mt-8">Your Choices About Your Information</h2>
                ...
                <ul>
                  ...
                  <li>
                    You can opt-out of receiving promotional emails by following the unsubscribe instructions in each
                    email.
                  </li>
                  <li>
                ...
                <h2 className="text-2xl font-bold text-navy mb-4 mt-8">Changes to Our Privacy Policy</h2>
                <p>
                ...
                <p>
                  <strong>Email:</strong>{" "}
                  <a href="mailto:privacy@linkify.com" className="text-teal hover:underline">
                    privacy@linkify.com
                  </a>
                </p>
                <p>
                  <strong>Phone:</strong>{" "}
                  <a href="tel:+18889701698" className="text-teal hover:underline">
                    +1 (888) 970-1698
                  </a>
                </p>
                <p>
                  <strong>Mail:</strong> Linkify Privacy Office, 1234 Digital Ave, Suite 100, Tech City, TX 75001
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 bg-light">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-navy mb-12 text-center">Our Commitment to Privacy</h2>
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-lg shadow-md text-center">
                ...
                <h3 className="text-xl font-bold text-navy mb-4">Secure Transactions</h3>
                <p className="text-gray-600">
                  All payment information is encrypted using industry-standard protocols to ensure your financial data
              ...
              <div className="bg-white p-8 rounded-lg shadow-md text-center">
                ...
                <p className="text-gray-600">
                  We believe in clear communication about how we collect and use your data, giving you control over your
